...
char_u _vimruntime_dir[PATH_MAX];
char_u _vim_dir[PATH_MAX];

char_u* default_vimruntime_dir = _vimruntime_dir;
char_u* default_vim_dir = _vim_dir;
char_u* compiled_user = "momodalo@gmail.com";
char_u* compiled_sys = "app.momodalo.net";
char_u* all_cflags = "-DHAVE_CONFIG_H";
char_u* all_lflags = "";
